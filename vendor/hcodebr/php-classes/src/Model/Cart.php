...
class Cart extends Model {
	...
	public function getProducts()
	{
		...
		$rows = $sql->select("
			SELECT b.idproduct, b.desproduct, b.vlprice, b.vlfilling, b.vlweight, b.desurl, COUNT(*) AS nrqtd, SUM(b.vlprice) AS vltotal
	...
	public function getProductsTotals()
	{
		...
		$results = $sql->select("
			SELECT SUM(vlprice) AS vlprice, SUM(vlweight) AS vlweight, COUNT(*) AS nrqtd
			FROM tb_products a
	...
	/** public function setFreight($nrzipcode)
	{
		...
		if ($totals['nrqtd'] > 0) {
			...
			if($totals['vlprice'] < 18.50) $totals['vlprice'] = 18.50;
