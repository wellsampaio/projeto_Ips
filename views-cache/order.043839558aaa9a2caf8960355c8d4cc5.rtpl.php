...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            De
            <address>
                <strong>CASA DE DONA BRASILINA</strong><br>
               Rua Irapuru, 00 - 02960070<br>
                Freguesia do Ó - SP<br>
                Telefone: (00) 0000-0000<br>
                E-mail: confeitaria@brasilina.com.br
            </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
            ...
            <address>
                ...
                E-mail: <?php echo htmlspecialchars( $order["desemail"], ENT_COMPAT, 'UTF-8', FALSE ); ?><br>
                Data de Entrega: <?php echo formatDate($order["desdelivery"]); ?>
            </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
        ...
        <div class="row">
            ...
            <div class="col-xs-6">
                ...
                <table class="table">
                    ...
                    <tr>
                        <th>Parcelas:</th>
                        <td><?php echo htmlspecialchars( $order["quantity"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                    </tr>
                    <!--
                    <tr>
