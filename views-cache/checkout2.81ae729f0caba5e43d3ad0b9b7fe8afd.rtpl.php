...
<form class="form-horizontal" action="/checkout2" method="post" name="checkout2">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-2">
    <input id="cep" name="NumSM" placeholder="Apenas números" class="form-control input-md" value="<?php echo htmlspecialchars( $address["NumSM"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" type="search">
  </div>
    <div class="col-md-2">
      <button type="submit" class="btn btn-primary" formaction="/checkout2" formmethod="get">Pesquisar</button>
    </div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <div class="input-group">
      ...
      <input id="rua" name="Cliente" class="form-control" placeholder=""  readonly="readonly" type="text" value="<?php echo htmlspecialchars( $address["Cliente"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
    </div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <div class="input-group">
      ...
      <input id="cidade" name="cidade" class="form-control" placeholder="" readonly="readonly" type="text" value="<?php echo htmlspecialchars( $address["nomeTransportador"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
    </div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <div class="input-group">
      <span class="input-group-addon">Corretora</span>
      <input id="rua" name="" class="form-control" placeholder="" type="text" value="">
    </div>
...
<div class="col-md-4">
    <div class="input-group">
      <span class="input-group-addon">Reguladora</span>
      <input id="rua" name="rua" class="form-control" placeholder="" type="text">
    </div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    ...
    <label class="radio-inline" for="radios-1">
      ...
      <input id="enc_instituicao" name="enc" class="form-control" type="text" placeholder="Telefone" >
...
<div class="form-group">
  ...
  <div class="col-md-2">
   ...
   <label class="col-md-1 control-label" for="radios">Iscas<h11>*</h11></label>
  <div class="col-md-4"> 
    <label class="radio-inline" for="radios-0" >
...
<div class="form-group">
 <label class="col-md-2 control-label" for="radios">Iscas Posicionando<h11>*</h11></label>
  ...
  <div class="col-md-3">
    <div class="input-group">
      <span class="input-group-addon">Tecnologia Isca</span>
      <input id="prependedtext" name="prependedtext" class="form-control" type="text">
    </div>
  </div>
</div>
...
<div class="col-md-4">
    <div class="input-group">
      ...
      <input id="rua" name="descorigem" class="form-control" placeholder="" readonly="readonly" type="text" value="<?php echo htmlspecialchars( $address["descorigem"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
    </div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <div class="input-group">
      ...
      <input id="rua" name="descdestino" class="form-control" placeholder="" readonly="readonly" type="text" value="<?php echo htmlspecialchars( $address["descdestino"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
    </div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <div class="input-group">
      <span class="input-group-addon">Nota Fiscal</span>
      <input id="cidade" name="cidade" class="form-control" placeholder="" type="text" readonly="readonly">
    </div>
