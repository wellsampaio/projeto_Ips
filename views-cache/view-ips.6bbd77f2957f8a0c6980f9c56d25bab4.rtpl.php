...
<div class="form-group" id= "formulario">
  ...
  <div class="col-md-2">
    <div class="input-group">
      <input id="acionamento" name="" placeholder="Tipo de acionamento" class="form-control" type="text" value="<?php echo htmlspecialchars( $value1["tipo_acionamento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" readonly="readonly" >
    </div>

     <div class="input-group" style="display: none;">
      <input id="acionamento" name="" placeholder="Tipo de acionamento" class="form-control" type="text" value="<?php echo htmlspecialchars( $value1["idacionamento"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" readonly="readonly" >
    </div>
  </div>
    ...
    <div class="input-group">
      <input id="prependedtext" name="" class="form-control" type="datetime-local" value="<?php echo htmlspecialchars( $value1["datah"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" readonly="readonly">
    </div >
  </div>
  <div class="col-md-1" style="margin-left: -55px">
    <div class="input-group">
      <input id="prependedtext" name="" class="form-control" placeholder="Nome" type="text" value="<?php echo htmlspecialchars( $value1["nome"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" readonly="readonly">
    </div>
  ...
  <div class="col-md-2" style="margin-left: -20px">
   ...
   <div class="col-md-2" style="margin-left: -50px">
    <div class="input-group">
      ...
      <input id="local" name="" class="form-control" placeholder="Local" type="text" value="<?php echo htmlspecialchars( $value1["local"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" readonly="readonly">
  ...
  <div class="col-md-2" style="margin-left: -50px">
    <div class="input-group">
      <input id="descricao" name="" class="form-control" placeholder="Descrição do Acionamento" type="text" value="<?php echo htmlspecialchars( $value1["descricao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" readonly="readonly">
    </div>
  </div>
