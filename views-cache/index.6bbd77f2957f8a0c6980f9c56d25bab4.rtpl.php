...
-->
		...
		<div class="container">
				<div class="img-slider">
						<!----start-slider-script---->
					<script src="/res/site/js2/responsiveslides.min.js"></script>
					 <script>
			...
			<div class="container">
				...
				<div class="col-md-4 top-grid">
					...
					<div class="top-grid-info">
						...
						<div class="clearfix"> </div>
						<a class="btn" href="/products/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">Comprar</a>
					</div>
